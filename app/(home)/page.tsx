...
export default function HomePage() {
  ...
  return (
    <main className="flex flex-1 flex-col gap-3 justify-center items-center text-center">
      ...
      <h1 className='text-5xl font-semibold  tracking-[-0.7px] leading-[140%] '>The <span className='p-1  bg-purple-500  '>Ultimate-NextJS </span> <br /> Components Library </h1>
      ...
      <ul className="list-none flex flex-col gap-1 mt-5 font-medium  items-start">
